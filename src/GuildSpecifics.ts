...
export function getChannels(guildId: string | undefined) : Channels {
    ...
    if (guildId === '1391860635347849367') {
        result = {
            ...
            reminderChannel1: '1391860639063871585',
            reminderChannel2: '1391860639063871586',
            reminderChannel3: '1391860639584096316',
    ...
    if (guildId === '885457551397912596') {
        result = {
            ...
            reminderChannel6: '1422202006793097328',
            reminderChannel7: '1422618338927841431',
